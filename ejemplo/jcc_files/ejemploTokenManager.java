...
/* Generated By:JavaCC: Do not edit this line. ejemploTokenManager.java */
package traductor;

/** Token Manager. */
public class ejemploTokenManager implements ejemploConstants {
...
static private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public ejemploTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public ejemploTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
